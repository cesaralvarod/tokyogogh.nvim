...
function M.load(theme)
	...
	local groups = {
		...
		["javascriptLabel"] = { fg = theme.magenta },
		...
		["typescriptVariableDeclaration"] = { fg = theme.yellow },
		...
		["typescriptMember"] = { fg = theme.cyan },
		["typescriptObjectLabel"] = { fg = theme.cyan },
		["typescriptObjectLiteral"] = { fg = theme.red },
		...
		["typescriptConditionalParen"] = { fg = theme.red },
		["typescriptLoopParen"] = { fg = theme.red },
		["typescriptParenExp"] = { fg = theme.red },
		["typescriptProp"] = { fg = theme.cyan },
		["typescriptArray"] = { fg = theme.red },
		["typescriptArrayMethod"] = { fg = theme.blue },
		["typescriptStringMethod"] = { fg = theme.blue },
		["typescriptPromiseMethod"] = { fg = theme.blue },
		["typescriptDOMElementTargetMethod"] = { fg = theme.blue },
		["typescriptTry"] = { fg = theme.magenta },
		["typescriptExceptions"] = { fg = theme.magenta },
		["typescriptFuncCallArg"] = { fg = theme.red },
		["typescriptMemberOptionality"] = { fg = theme.cyan },
		["typescriptTypeAnnotation"] = { fg = theme.cyan },
		["typescriptDefaultParam"] = { fg = theme.cyan },

		["tsxCloseString"] = { fg = theme.white },
		["tsxAttrib"] = { fg = theme.blue, italic = true },
		["tsxTagName"] = { fg = theme.yellow },
		["tsxRegion"] = { fg = theme.green },
		["tsxIdentifierName"] = { fg = theme.yellow },
		["tsxMemberOptionality"] = { fg = theme.cyan },

		["jsonQuote"] = { fg = theme.red },
		["jsonKeywordMatch"] = { fg = theme.red },
		["jsonFold"] = { fg = theme.red },
		["jsonBraces"] = { fg = theme.rainbowc1 },
		["jsonStringMatch"] = { fg = theme.green },

		["shDerefSimple"] = { fg = theme.red },
		["shEcho"] = { fg = theme.cyan },
		["shFunctionOne"] = { fg = theme.cyan },
		["shStatement"] = { fg = theme.cyan },
		["shFor"] = { fg = theme.red },
		["shLoop"] = { fg = theme.magenta },
		["shTestOpr"] = { fg = theme.cyan },

		["goBlock"] = { fg = theme.red },

		["pythonAttribute"] = { fg = theme.blue },

		["luaFunctionBlock"] = { fg = theme.blue },
		["luaFunction"] = { fg = theme.magenta },
		["luaFunc"] = { fg = theme.cyan },
		["luaParen"] = { fg = theme.red },
		["luaTableBlock"] = { fg = theme.white },

		["cssTagName"] = { fg = theme.red },
		["cssBraces"] = { fg = theme.rainbowc1 },
		["cssClassName"] = { fg = theme.blue },
		["cssIdentifier"] = { fg = theme.blue },
		["cssDefinition"] = { fg = theme.white },
		["cssTextProp"] = { fg = theme.white },
		["cssBackgroundProp"] = { fg = theme.white },
		["cssBoxProp"] = { fg = theme.white },
		["cssFontProp"] = { fg = theme.white },
		["cssBorderProp"] = { fg = theme.white },
		["cssPageProp"] = { fg = theme.white },
		["cssAtRule"] = { fg = theme.magenta },
		["cssAtRuleLogical"] = { fg = theme.cyan },
		["cssMediaType"] = { fg = theme.white },
		["cssMediaProp"] = { fg = theme.white },
		["cssNoise"] = { fg = theme.cyan },

		["sassClass"] = { fg = theme.blue },
		["sassClassChar"] = { fg = theme.blue },
		["sassId"] = { fg = theme.blue },
		["sassIdChar"] = { fg = theme.blue },
		["sassAmpersand"] = { fg = theme.red },
		["sassProperty"] = { fg = theme.white },
		["sassMedia"] = { fg = theme.magenta },

		["javaFold"] = { fg = theme.red },
		["javaType"] = { fg = theme.magenta },
		["javaParentT"] = { fg = theme.white },

		["markdownH1"] = { fg = theme.red },
		["markdownH2"] = { fg = theme.red },
		["markdownH3"] = { fg = theme.red },
		["markdownH4"] = { fg = theme.red },
		["markdownH5"] = { fg = theme.red },
		["markdownH6"] = { fg = theme.red },
		["markdownH1Delimiter"] = { fg = theme.red },
		["markdownH2Delimiter"] = { fg = theme.red },
		["markdownH3Delimiter"] = { fg = theme.red },
		["markdownH4Delimiter"] = { fg = theme.red },
		["markdownH5Delimiter"] = { fg = theme.red },
		["markdownH6Delimiter"] = { fg = theme.red },
		["markdownEscape"] = { fg = theme.cyan },
		["markdownBold"] = { fg = theme.orange, bold = true },
		["markdownItalic"] = { fg = theme.magenta, italic = true },
		["markdownStrike"] = { strikethrough = true },
		["markdownCodeDelimiter"] = { fg = theme.green },
		-- ["markdownCode"] = { fg = theme.green },
		["markdownLink"] = { fg = theme.magenta, underline = true },
		["markdownLinkText"] = { fg = theme.blue },
		["markdownUrl"] = { fg = theme.magenta, underline = true },
		["markdownBlockQuote"] = { fg = theme.yellow },

		["phpRegion"] = { fg = theme.yellow },
		["phpVarSelector"] = { fg = theme.red },
		["phpComparision"] = { fg = theme.cyan },
		["phpParen"] = { fg = theme.rainbowc1 },
		["phpDefine"] = { fg = theme.magenta },
		["phpSpecialFunction"] = { fg = theme.cyan },
		["phpStructure"] = { fg = theme.magenta },
		["phpLabel"] = { fg = theme.magenta },
		["phpIdentifier"] = { fg = theme.red },
		["phpMethodsVar"] = { fg = theme.red },
		["phpMemberSelector"] = { fg = theme.white },
		["phpType"] = { fg = theme.cyan },

		["cType"] = { fg = theme.magenta },
		["cCharacter"] = { fg = theme.green },

		["cppStructure"] = { fg = theme.magenta },
